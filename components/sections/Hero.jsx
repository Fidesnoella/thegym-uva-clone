    ...
    return (
        <div className='px-[0.625rem] xl:px-2 mx-auto container max-w-none xl:max-w-[87.5rem]'>
            <div className="max-w-[40.3125rem] lg:max-w-[72.875rem] mx-auto px-3">
                <div className="pt-[3.625rem] grid lg:grid-cols-2">
                    ...
                    <div >
                        <Image src={flip} className="object-cover shadow-5xl" />
                    </div>
                </div>
                <div className="flex flex-col justify-center lg:justify-start items-center px-8 lg:px-0 lg:flex-row gap-4 -translate-y-32 lg:-translate-y-40">
                    {
